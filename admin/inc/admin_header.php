               ...
               <<?php
                ...
                <div class="floatleft marginleft10">
                    <ul class="inline-ul floatleft">
                        <li>Hello <?php echo session::get("user")?></li>
    ...
    <div class="grid_12">
        <ul class="nav main">
            ...
            <li class="ic-grid-tables"><a href="inbox.php"><span>Inbox
                    ...
                    if($show_post_run){
                        $count = mysqli_num_rows($show_post_run);
                        echo "(".$count.")";
                    }else{
                        echo "0";
                    }
           ...
           <?php if(session::get("userrole") == "0"){ ?>
               ...
               <li class="ic-charts"><a href="add_role_user.php"><span>Add User</span></a></li>

           <?php } ?>
            <li class="ic-charts"><a href="listuser.php"><span>List User</span></a></li>
        </ul>
    </div>
    <div class="clear">
    </div>